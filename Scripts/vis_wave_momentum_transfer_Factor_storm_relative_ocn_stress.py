...
factors = [
    ...
    ('awo_ws_wave_mom_trans_factor', 1, '$EXP$'),
    ('awo_wave_mom_trans_factor', 3, '$CTL$'),
    ('awo_ws_wave_mom_trans_factor', 3, '$EXP$'),
    ('awo_wave_mom_trans_factor', 5, '$CTL$'),
    ('awo_ws_wave_mom_trans_factor', 5, '$EXP$'),
    ('awo_wave_mom_trans_factor', 7, '$CTL$'),
    ('awo_ws_wave_mom_trans_factor', 7, '$EXP$'),
]
...
plt.savefig(PNG + 'mom_trans_fact_stress_evolution.png', dpi=300, bbox_inches='tight',
