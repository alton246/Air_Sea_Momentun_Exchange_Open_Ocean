...
add_corner_label(ax1, 0.02, 0.84, '(a)', fontsize=5.5)
...
add_corner_label(ax2, 0.02, 0.84, '(b)', fontsize=5.5)
...
plt.savefig(PNG + 'fig2_track_wspd_intensity_ESS.png', dpi=300, bbox_inches='tight',
