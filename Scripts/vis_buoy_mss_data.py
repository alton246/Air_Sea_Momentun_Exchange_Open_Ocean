...
NDBC_PATH = '/home/disk/orca/adaley17/orca3/adaley17/data/ndbc/spectral_data/'
PNG='/home/disk/orca3/adaley17/Projects/Air_Sea_Momentun_Exchange_Open_Ocean/Figures/'

#Buoy Files 
buoy_file_043 = '41043w2010.txt'
buoy_file_046 = '41046w2010.txt'

#Accessing Buoy Data
df_043 = pd.read_csv(NDBC_PATH + buoy_file_043, sep='\s+', encoding='ISO-8859-1', engine='python')
df_046 = pd.read_csv(NDBC_PATH + buoy_file_046, sep='\s+', encoding='ISO-8859-1', engine='python')
...
awo_swh_046, awo_ws_swh_046 = extract_swh_series(wave_files, DWM_PATH, 'mss', buoy_lat[1], buoy_lon[1])
awo_swh_043, awo_ws_swh_043 = extract_swh_series(wave_files, DWM_PATH, 'mss', buoy_lat[0], buoy_lon[0])

buoy_043_qc = clean_buoy_data(df_043) #Cleaning Buoy Data
buoy_046_qc = clean_buoy_data(df_046) #Cleaning Buoy Data

subset_df_043 = buoy_043_qc['2010-08-27 00:00:00':'2010-09-01 12:00:00'] #Subsetting Buoy Data
subset_df_046 = buoy_046_qc['2010-08-27 00:00:00':'2010-09-01 12:00:00']#Subsetting Buoy Data

#Computing the Mean Square Slope from NOAA/NDBC buoy data
subset_df_043 = compute_mean_square_slope(subset_df_043, subset_df_043.columns)
subset_df_046 = compute_mean_square_slope(subset_df_046, subset_df_046.columns)
...
ax2.plot(subset_df_043.index, subset_df_043['mean_square_slope'], color='k', lw=lw, label='Buoy 41043')
ax2.plot(buoy_date_int, awo_swh_043[start_index:end_index], color='red', lw=lw, label='CTL')
ax2.plot(buoy_date_int, awo_ws_swh_043[start_index:end_index], color='cyan', lw=lw, label='EXP')

ax2.set_ylim(ymin, ymax)


ax2.set_xlabel('Date (mm-dd)', fontsize=fontsize)
ax2.set_ylabel('Mean Square Slope ', fontsize=fontsize)
...
ax3.plot(subset_df_046.index, subset_df_046['mean_square_slope'], color='k', lw=lw, label='Buoy 41046', )
ax3.plot(buoy_date_int, awo_swh_046[start_index:end_index], color='red', lw=lw, label='CTL')
ax3.plot(buoy_date_int, awo_ws_swh_046[start_index:end_index], color='cyan', lw=lw, label='EXP')

ax3.set_ylim(ymin, ymax)
ax3.set_xlabel('Date mm-dd', fontsize=fontsize)
ax3.set_ylabel('Mean Square Slope ', fontsize=fontsize)
...
plt.savefig(PNG + 'buoy_mss_analysis.png', dpi=300, bbox_inches='tight',
