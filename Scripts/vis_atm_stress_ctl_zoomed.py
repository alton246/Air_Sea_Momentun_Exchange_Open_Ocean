...
factors = [
    ('awo_atm_stress', 1, '$CTL$'),
    ('awo_atm_stress', 1, '$CTL$'),
    ('awo_atm_stress', 3, '$CTL$'),
    ('awo_atm_stress', 3, '$CTL$'),
    ('awo_atm_stress', 5, '$CTL$'),
    ('awo_atm_stress', 5, '$CTL$'),
    ('awo_atm_stress', 7, '$CTL$'),
    ('awo_atm_stress', 7, '$CTL$'),
]
...
cb.set_label('ATM Stress (N/m²)', fontsize=6, labelpad=2)


fig.tight_layout(pad=0, w_pad=-10, h_pad=0.5)

plt.savefig(PNG + 'atm_stress_zoomed.png', dpi=300, bbox_inches='tight',
