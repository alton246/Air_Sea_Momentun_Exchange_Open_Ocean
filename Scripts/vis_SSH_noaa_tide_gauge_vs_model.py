...
#Buoy Locations
buoy_names = ['9751364', '9751381', '9751639']
buoy_lat = [17.7483, 18.31833, 18.33]
buoy_lon = [-64.6983, -64.725, -64.925]
...
# def extract_for_buoy(args):
#     wave_files, DWM_PATH, lat, lon = args
#     return extract_swh_series(wave_files, DWM_PATH, lat, lon)

# buoy_coords = [(wave_files, DWM_PATH, buoy_lat[1], buoy_lon[1]),
#                (wave_files, DWM_PATH, buoy_lat[0], buoy_lon[0])]

# with ThreadPoolExecutor(max_workers=2) as executor:
#     results = list(executor.map(extract_for_buoy, buoy_coords))

# awo_swh_046, awo_ws_swh_046 = results[0]
# awo_swh_043, awo_ws_swh_043 = results[1]
...
ax1.scatter(buoy_lon, buoy_lat, c='b', s=markersize*10, marker='*')
...
plt.savefig(PNG + 'SSH_gauge_analysis.png', dpi=300, bbox_inches='tight',
