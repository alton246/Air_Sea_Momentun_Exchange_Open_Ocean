...
factors = [
    ...
    ('exp_stress_diff', 1, '$EXP$'),
    ('ctl_stress_diff', 3, '$CTL$'),
    ('exp_stress_diff', 3, '$EXP$'),
    ('ctl_stress_diff', 5, '$CTL$'),
    ('exp_stress_diff', 5, '$EXP$'),
    ('ctl_stress_diff', 7, '$CTL$'),
    ('exp_stress_diff', 7, '$EXP$'),
]
...
plt.savefig(PNG + 'atm-ocean_stress_diff.png', dpi=300, bbox_inches='tight',
